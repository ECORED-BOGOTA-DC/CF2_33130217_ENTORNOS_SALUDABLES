  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.align-items-center.mb-5
      .col-lg-5.mb-4.mb-lg-0(data-aos="fade-right")
        figure
          img(src='@/assets/curso/tema3/img1.png', style="width: 500px" ,alt='').m-auto
    ...
    TabsB.color-acento-contenido.mb-5(data-aos="fade-down")
      ...
      .py-4.py-md-5(titulo="Grupos de ayuda mutua o autoayuda" :icono="require('@/assets/curso/tema3/img2.svg')")
        .row.justify-content-center
          .col-lg-7.mb-4.mb-lg-0
    ...
    .row.align-items-center
      .col-lg-4.mb-4.mb-lg-0(data-aos="fade-right")
        figure
          img(src='@/assets/curso/tema3/img4.png', style="width: 280px" ,alt='').m-auto
