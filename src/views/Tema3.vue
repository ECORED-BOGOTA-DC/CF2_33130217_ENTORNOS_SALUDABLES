        ...
        .bloque-texto-a.color-secundario.p-4.p-md-5
          .row.m-0.align-items-center.justify-content-between
            .col-lg-4.mb-4.mb-lg-0
              p.mb-0 #[b Tanto los grupos de apoyo como los de ayuda mutua y autoayuda tienen como objetivo:]
            .col-lg-8
              .bloque-texto-a__texto.p-4
                p.mb-0 Ayudar a que las personas con problemas o trastornos en salud mental puedan romper con el estigma de la enfermedad mental, fomentando un estado positivo de su salud, permiten que las personas tengan conversaciones difíciles acerca de sus miedos, emociones y sentimientos y de esta forma lograr encontrar caminos para gestionarlos. De igual forma, los grupos de apoyo brindan la posibilidad de tener el apoyo de un profesional dispuesto a brindar psicoeducación, orientación y seguimiento de casos.
