...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      .col-lg-10.mb-5
        figure
          img(src="@/assets/curso/temas/sintesis.svg", alt="La gráfica muestra la sintesis del componente formativo: Promoción y Prevención de la salud mental, teniendo yres enfoques principales: RIA SALUD MENTAL, Coordinación intersectorial y atención rehabilitación y seguimiento.")
      .col-auto
